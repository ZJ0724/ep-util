...
public class Sftp {
    ...
    public void connect() {
        ...
        try {
            ...
            throw new com.easipass.epUtil.core.exception.SftpException("sftp: " + this.url + ", 连接失败");
        }
    ...
    private void checkConnect() {
        if (!this.isConnect) {
            throw new com.easipass.epUtil.core.exception.SftpException("sftp: " + this.url + ", 未连接");
        }
    }
