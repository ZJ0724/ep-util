package com.easipass.epUtil.core.entity.config;

import com.easipass.epUtil.core.entity.Config;
import com.easipass.epUtil.core.entity.resources.config.DaKaPropertiesResource;
...
public final class DaKaProperties extends Config {
     ...
     * 单例
     * */
    private static DaKaProperties DA_KA_PROPERTIES;
    ...
    public static DaKaProperties getInstance() {
        if (DA_KA_PROPERTIES == null) {
            DA_KA_PROPERTIES = new DaKaProperties();
        }
