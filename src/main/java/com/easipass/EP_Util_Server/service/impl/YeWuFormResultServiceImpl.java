...
public class YeWuFormResultServiceImpl implements FormResultService {
    ...
    public void upload() {
        ...
        //上传到sftp
        try {
            SftpUtil.uploadFile(Application_properties.uploadPath,new ByteArrayInputStream(document.asXML().getBytes()),"yeWuFormResult-"+this.yeWuFormResultBean.getCus_ciq_no()+"-"+ DateUtil.getTime());
