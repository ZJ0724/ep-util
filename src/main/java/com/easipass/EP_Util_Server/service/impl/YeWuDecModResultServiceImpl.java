    ...
    public void upload() {
        ...
        try {
            SftpUtil.uploadFile(
                    ...
                    Application_properties.uploadPath,new ByteArrayInputStream(document.asXML().getBytes()),"yeWuDecModResult-"+this.yeWuDecModResultBean.getDestResourceId()+"-"+ DateUtil.getTime());
