    ...
    public void upload() {
        ...
        try {
            SftpUtil.uploadFile(
                    ...
                    Application_properties.uploadPath,new ByteArrayInputStream(document.asXML().getBytes()),"QPDecModResult-"+this.qpDecModResultBean.getDecModSeqNo()+"-"+ DateUtil.getTime());
